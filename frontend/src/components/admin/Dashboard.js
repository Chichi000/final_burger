...
import { monthlySalesChart, productSalesChart, weeklySalesChart} from '../../actions/chartActions'
...
const Dashboard = () => {
    ...
    // const { salesPerWeek, } = useSelector(state => state.salesPerWeek)
    ...
    useEffect(() => {
        ...
        dispatch(weeklySalesChart())

    }, [dispatch])

    return (
        <Fragment>
             <div className="row" style={{backgroundImage: "url(/images/home-bg.png)", backgroundRepeat: 'no-repeat',backgroundPosition: "center", backgroundSize:"cover", marginTop: "5.5rem"}}>
                ...
                <div className="col-12 col-md-10">
                    ...
                    {loading ? <Loader /> : (
                        <Fragment>
                            ...
                            <Fragment>
                                {/* <WeeklySalesChart data={salesPerWeek} /> */}
                            </Fragment>
                            <Fragment>
