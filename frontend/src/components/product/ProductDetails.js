        ...
        <Fragment>
            {loading ? <Loader /> : (
                <Fragment>
                    ...
                    <div className="row d-flex justify-content-around"  style={{backgroundImage: "url(/images/log.png)", backgroundRepeat: 'no-repeat',backgroundPosition: "center", backgroundSize:"cover"}} >
                        <div className="col-12 col-lg-5 img-fluid" id="product_image">
                            <Carousel pause='hover' style={{width:'200px', height:'200px', marginLeft:'950px', borderStyle:'solid', borderColor:'white', borderRadius:'20px'}}>
                        ...
                        <div className="col-10 col-lg-3 mt-3" style={{marginLeft:'400px', backgroundColor:'orange'}}>
                            <h3>{product.name}</h3>
